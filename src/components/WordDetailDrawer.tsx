...
export default function WordDetailDrawer({ word, onClose, onAskLina, isSandboxMode }: { word: VocabWord | null; onClose: () => void; onAskLina: (p: string) => void; isSandboxMode: boolean }) {
