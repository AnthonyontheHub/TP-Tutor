...
export const TOKI_PONA_DICTIONARY: Record<string, string> = {
  ...
  "kasi": "plant, leaf", "ken": "can, possible", "kepeken": "use, with", "kili": "fruit, vegetable", "kiwen": "hard, rock, metal", "ko": "clay, paste, powder", "kon": "air, spirit, soul", "kule": "color, colorful", "kulupu": "group, community", "kute": "hear, listen",
  ...
  "mu": "cute animal sound", "mun": "moon, star", "musi": "fun, play, art", "mute": "many, very, much", "nanpa": "number, digit",
